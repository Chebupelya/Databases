...
--TASK 7
SELECT sequence_name FROM all_sequences WHERE sequence_owner = 'INSCORE';

SELECT privilege FROM dba_sys_privs WHERE grantee = 'INSCORE';

GRANT CREATE DATABASE LINK, CREATE PUBLIC DATABASE LINK, DROP PUBLIC DATABASE LINK TO INSCORE;

GRANT CREATE CLUSTER TO INSCORE;
GRANT CREATE MATERIALIZED VIEW TO INSCORE;
...
--TASK 14
CREATE SYNONYM my_c_syn FOR INSCORE.C;
SELECT * FROM my_c_syn;

--TASK 15
CREATE PUBLIC SYNONYM public_b_syn FOR INSCORE.B;
...
CREATE DATABASE LINK D_LINK4
CONNECT TO U1 IDENTIFIED BY 1234
USING '(DESCRIPTION=
...
select * from SYS.T1234@D_LINK4;
COMMIT;
insert into SYS.T1234@D_LINK4 values (11);

CREATE USER U1234 IDENTIFIED BY pass;

CREATE TABLE T1234 (x number);
INSERT INTO T1234 VALUES (1);
GRANT SELECT ON T1234 TO U1234;