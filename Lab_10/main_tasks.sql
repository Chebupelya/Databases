...
INSERT INTO T_LIST (region, sales) VALUES ('D', 25000); -- будет помещена в секцию p4 (DEFAULT)
...
SELECT * FROM T_INTERVAL PARTITION (SYS_P1363); 
SELECT * FROM T_INTERVAL PARTITION (SYS_P1364);

SELECT * FROM T_HASH PARTITION (SYS_P1359);
SELECT * FROM T_HASH PARTITION (SYS_P1360);
SELECT * FROM T_HASH PARTITION (SYS_P1362);
